...
def do_cv(regularizer, dataset_path, split_name):
    ...
    for fold in split.folds:
        ...
        # Evaluate classifier
        print "... fitting model"
        model = LogisticRegression(C=regularizer, penalty='l2', dual=True, class_weight='balanced', random_state=42).fit(X_train, y_train)
...
if __name__ == "__main__":
    ...
    model = LogisticRegression(C=best_regularizer, penalty='l2', dual=True, class_weight='balanced', random_state=42).fit(X_train, y_train)
